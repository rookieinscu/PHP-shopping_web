...
<div class="form-content">
	<ul>
		<form action=../classes/Reset_password_tel.php" method="post" >
			<li>
				<div class="form-group">
					<label class="control-label">您收到的验证码：</label>
						<input type="text" placeholder="验证码..." name="user_vertification" class="form-control form-underlined" id="user_vertification" required/>
				</div>
			</li>			<li>
				<div class="form-group">
